...
export const DIMENSION_DESCRIPTIONS: Record<keyof typeof DIMENSION_LABELS, string> = {
  quality: "Smoothed graduation rate + smoothed rugpull rate, Bayesian-adjusted so tiny samples aren't over- or under-penalized.",
  mechanism: "Contract verification, audit status, and LP-lock rate.",
  marketHealth: "Liquidity/volume depth, minus wash-trading and holder-concentration penalties.",
  value: "Capped median peak-vs-launch price multiple, so one outlier token can't dominate a launchpad's average.",
  consistency: "Recency-weighted outcome stability across a launchpad's history, variance-penalized.",
};
