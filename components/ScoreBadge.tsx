...
export default function ScoreBadge({
  ...
  if (isProvisional) {
    ...
    return (
      <div
        ...
        title={`Provisional: sample size ${sampleSize} (confidence threshold ${MIN_SAMPLE_SIZE_FOR_CONFIDENCE}), and/or some dimensions have no data yet. Star rating capped until more data is tracked.`}
      >
  ...
  return (
    ...
    >
      <div className="flex flex-col items-start">
        <span
          className={`font-mono font-semibold ${RAMP_CLASSES[color]} ${dims.num}`}
        >
          {score.toFixed(1)}
        </span>
