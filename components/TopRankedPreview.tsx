        ...
        return (
          <Reveal key={lp.id} delay={i * 0.06}>
            <Link
              ...
              className={`group relative block h-full overflow-hidden rounded-xl border border-line bg-card p-5 transition-all duration-300 ease-out hover:-translate-y-1 ${a.ring} ${a.glow}`}
            >
              <span
